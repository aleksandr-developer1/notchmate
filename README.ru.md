...
<p align="center"><b>Русский</b> · <a href="README.md">English</a></p>
...
<p align="center">Если NotchMate делает ваш день чуть приятнее — поставьте ⭐ репозиторию, это помогает проекту расти.<br>
Идеи и ошибки — в <a href="https://github.com/aleksandr-developer1/notchmate/issues">issues</a>, вопросы — в <a href="https://github.com/aleksandr-developer1/notchmate/discussions">обсуждениях</a>. Хотите помочь с кодом — загляните в <a href="CONTRIBUTING.md">CONTRIBUTING</a>.</p>
